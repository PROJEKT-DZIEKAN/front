...
export default function SimpleSurveyTest() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Prosty Test Ankiet</h1>
          <p className="text-gray-600">Twórz i edytuj ankiety - bez problemów z eventami</p>
        </div>
